...
Quiz ToolKit is a web platform system which automates quizes managing. Teachers and students are the target audience. The main features that it has to offer are:
\begin{itemize}
